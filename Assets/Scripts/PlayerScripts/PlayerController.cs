...
public class PlayerController : MonoBehaviour
{
    ...
    */
    ...
    public void TriggerSlowPlayer(float slowDuration, float slowMagnitude)
    {
    ...
    {
        rigidBody.linearVelocity = new Vector2(moveInput * currentSpeed, rigidBody.linearVelocity.y);
